...
/// 这个可能需要变化 https://api.ethermine.org/miner/c0c00cd1d93fb7e3f7d34bdd9007e360ef6c2556/workers
...
public enum Service {
    case payouts(miner: String)
    case workers(miner: String)
...
extension Service: TargetType {
    ...
    public var path: String {
        switch self {
        case .payouts(let miner):
            return "/miner/\(miner)/payouts"
        case .workers(let miner):
            return "/miner/\(miner)/workers"
        case let .Tx(tailURL):
